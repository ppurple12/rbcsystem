...
SWIGEXPORT jint JNICALL Java_com_google_ortools_algorithms_mainJNI_KnapsackSolver_1KNAPSACK_1MULTIDIMENSION_1SCIP_1MIP_1SOLVER_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  operations_research::KnapsackSolver::SolverType result;
  
  (void)jenv;
  (void)jcls;
  result = (operations_research::KnapsackSolver::SolverType)operations_research::KnapsackSolver::KNAPSACK_MULTIDIMENSION_SCIP_MIP_SOLVER;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_com_google_ortools_algorithms_mainJNI_KnapsackSolver_1KNAPSACK_1DIVIDE_1AND_1CONQUER_1SOLVER_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  operations_research::KnapsackSolver::SolverType result;
  
  (void)jenv;
  (void)jcls;
  result = (operations_research::KnapsackSolver::SolverType)operations_research::KnapsackSolver::KNAPSACK_DIVIDE_AND_CONQUER_SOLVER;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_com_google_ortools_algorithms_mainJNI_KnapsackSolver_1KNAPSACK_1MULTIDIMENSION_1CP_1SAT_1SOLVER_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  operations_research::KnapsackSolver::SolverType result;
  
  (void)jenv;
  (void)jcls;
  result = (operations_research::KnapsackSolver::SolverType)operations_research::KnapsackSolver::KNAPSACK_MULTIDIMENSION_CP_SAT_SOLVER;
  jresult = (jint)result; 
  return jresult;
}
...
SWIGEXPORT void JNICALL Java_com_google_ortools_algorithms_mainJNI_KnapsackSolver_1init(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlongArray jarg2, jobjectArray jarg3, jlongArray jarg4) {
  ...
  std::vector< std::vector< int64_t > > result3 ;
  ...
  (arg1)->Init((std::vector< int64_t > const &)*arg2,(std::vector< std::vector< int64_t > > const &)*arg3,(std::vector< int64_t > const &)*arg4);
  {
    delete arg2;
  }
  {
