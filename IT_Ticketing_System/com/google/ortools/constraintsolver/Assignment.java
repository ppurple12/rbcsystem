...
/**
 *  An Assignment is a variable -&gt; domains mapping, used<br>
...
public class Assignment extends PropagationBaseObject {
  ...
  /**
   *  Loads an assignment from a file; does not add variables to the<br>
  ...
  public void AddObjectives(IntVar[] vars) {
    mainJNI.Assignment_AddObjectives(swigCPtr, this, vars);
  }
  ...
  public int NumObjectives() {
    return mainJNI.Assignment_NumObjectives(swigCPtr, this);
  }
  ...
  public IntVar ObjectiveFromIndex(int index) {
    long cPtr = mainJNI.Assignment_ObjectiveFromIndex(swigCPtr, this, index);
    return (cPtr == 0) ? null : new IntVar(cPtr, false);
  }
  ...
  public boolean HasObjectiveFromIndex(int index) {
    return mainJNI.Assignment_HasObjectiveFromIndex(swigCPtr, this, index);
  }
  ...
  public long ObjectiveMinFromIndex(int index) {
    return mainJNI.Assignment_ObjectiveMinFromIndex(swigCPtr, this, index);
  }

  public long ObjectiveMaxFromIndex(int index) {
    return mainJNI.Assignment_ObjectiveMaxFromIndex(swigCPtr, this, index);
  }

  public long ObjectiveValueFromIndex(int index) {
    return mainJNI.Assignment_ObjectiveValueFromIndex(swigCPtr, this, index);
  }

  public boolean ObjectiveBoundFromIndex(int index) {
    return mainJNI.Assignment_ObjectiveBoundFromIndex(swigCPtr, this, index);
  }

  public void SetObjectiveMinFromIndex(int index, long m) {
    mainJNI.Assignment_SetObjectiveMinFromIndex(swigCPtr, this, index, m);
  }

  public void SetObjectiveMaxFromIndex(int index, long m) {
    mainJNI.Assignment_SetObjectiveMaxFromIndex(swigCPtr, this, index, m);
  }

  public void SetObjectiveValueFromIndex(int index, long value) {
    mainJNI.Assignment_SetObjectiveValueFromIndex(swigCPtr, this, index, value);
  }

  public void SetObjectiveRangeFromIndex(int index, long l, long u) {
    mainJNI.Assignment_SetObjectiveRangeFromIndex(swigCPtr, this, index, l, u);
  }
  ...
  public void ActivateObjectiveFromIndex(int index) {
    mainJNI.Assignment_ActivateObjectiveFromIndex(swigCPtr, this, index);
  }

  public void DeactivateObjectiveFromIndex(int index) {
    mainJNI.Assignment_DeactivateObjectiveFromIndex(swigCPtr, this, index);
  }

  public boolean ActivatedObjectiveFromIndex(int index) {
    return mainJNI.Assignment_ActivatedObjectiveFromIndex(swigCPtr, this, index);
  }
  ...
  /**
   *  Copies the intersection of the two assignments to the current<br>
   *  assignment.
   */
  ...
  /**
   *  Copies 'assignment' to the current assignment, clearing its previous<br>
   *  content.
   */
