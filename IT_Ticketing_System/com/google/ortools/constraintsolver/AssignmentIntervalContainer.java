...
public class AssignmentIntervalContainer {
  ...
  protected static long swigRelease(AssignmentIntervalContainer obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  /**
   *  Advanced usage: Adds element at a given position; position has to have<br>
  ...
  /**
   *  Advanced usage: Resizes the container, potentially adding elements with<br>
   *  null variables.
   */
  ...
  /**
   *  Copies the elements of 'container' which are already in the calling<br>
   *  container.
   */
  ...
  /**
   *  Copies all the elements of 'container' to this container, clearing its<br>
   *  previous content.
   */
