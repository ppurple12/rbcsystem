...
public class DisjunctiveConstraint extends Constraint {
  ...
  /**
   *  Add a transition time between intervals.  It forces the distance between<br>
   *  the end of interval a and start of interval b that follows it to be at<br>
   *  least transition_time(a, b). This function must always return<br>
