 ...
 *  friend to the Solver class. It allows accessing methods useful when<br>
...
public class PropagationBaseObject extends BaseObject {
  ...
  /**
   *  This method freezes the propagation queue. It is useful when you<br>
  ...
  /**
   *  This method unfreezes the propagation queue. All modifications<br>
  ...
  /**
   *  This method pushes the demon onto the propagation queue. It will<br>
   *  be processed directly if the queue is empty. It will be enqueued<br>
