...
public class RoutingModelVisitor extends BaseObject {
  ...
  public RoutingModelVisitor(long cPtr, boolean cMemoryOwn) {
    super(mainJNI.RoutingModelVisitor_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }

  public static long getCPtr(RoutingModelVisitor obj) {
    return (obj == null) ? 0 : obj.swigCPtr;
  }

  public static long swigRelease(RoutingModelVisitor obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
