...
public class SearchMonitor extends BaseObject {
  ...
  /**
   *  Just after refuting or applying the decision, apply is true after Apply.<br>
  ...
  /**
   *  This method is called when a solution is found. It asserts whether the<br>
   *  solution is valid. A value of false indicates that the solution<br>
   *  should be discarded.
   */
  ...
  /**
   *  This method is called when a valid solution is found. If the<br>
   *  return value is true, then search will resume after. If the result<br>
  ...
  /**
   *  When a local optimum is reached. If 'true' is returned, the last solution<br>
  ...
  /**
   *  Returns true if the limit of solutions has been reached including<br>
   *  unchecked solutions.
   */
  ...
  /**
   *  Registers itself on the solver such that it gets notified of the search<br>
   *  and propagation events. Override to incrementally install listeners for<br>
   *  specific events.
   */
  public void install() {
