...
/**
 *  This class is the root class of all solution collectors.<br>
...
public class SolutionCollector extends SearchMonitor {
  ...
  public void install() {
    mainJNI.SolutionCollector_install(swigCPtr, this);
  }
  ...
  public void AddObjectives(IntVar[] objectives) {
    mainJNI.SolutionCollector_AddObjectives(swigCPtr, this, objectives);
  }
  ...
  public boolean has_solution() {
    return mainJNI.SolutionCollector_has_solution(swigCPtr, this);
  }
  ...
  public Assignment last_solution_or_null() {
    long cPtr = mainJNI.SolutionCollector_last_solution_or_null(swigCPtr, this);
    return (cPtr == 0) ? null : new Assignment(cPtr, false);
  }
  ...
  /**
   *  Returns the number of failures encountered at the time of the nth<br>
   *  solution.
   */
  ...
  public long ObjectiveValueFromIndex(int n, int index) {
    return mainJNI.SolutionCollector_ObjectiveValueFromIndex(swigCPtr, this, n, index);
  }
  ...
  /**
   *  This is a shortcut to get the ForwardSequence of 'var' in the<br>
   *  nth solution. The forward sequence is the list of ranked interval<br>
  ...
  /**
   *  This is a shortcut to get the BackwardSequence of 'var' in the<br>
   *  nth solution. The backward sequence is the list of ranked interval<br>
  ...
  /**
   *  This is a shortcut to get the list of unperformed of 'var' in the<br>
   *  nth solution.
   */
