...
public:
    ...
    virtual void Accept(operations_research::DecisionVisitor *visitor) const;
public:
...
public:
    ...
    virtual std::string DebugString() const;
    virtual void VisitSetVariableValue(operations_research::IntVar *var,int64_t value);
    virtual void VisitSplitVariableDomain(operations_research::IntVar *var,int64_t value,bool start_with_lower_half);
    virtual void VisitScheduleOrPostpone(operations_research::IntervalVar *var,int64_t est);
    virtual void VisitScheduleOrExpedite(operations_research::IntervalVar *var,int64_t est);
    virtual void VisitRankFirstInterval(operations_research::SequenceVar *sequence,int index);
    virtual void VisitRankLastInterval(operations_research::SequenceVar *sequence,int index);
...
public:
    ...
    SwigDirector_PathOperator(JNIEnv *jenv,std::vector< operations_research::IntVar * > const &next_vars,std::vector< operations_research::IntVar * > const &path_vars,int number_of_base_nodes,bool skip_locally_optimal_paths,bool accept_path_end_base,std::function< int (int64_t) > start_empty_path_class,std::function< std::vector< int > const &(int,int) > get_neighbors);
...
class SwigDirector_LocalSearchFilterManager : public operations_research::LocalSearchFilterManager, public Swig::Director {

public:
    void swig_connect_director(JNIEnv *jenv, jobject jself, jclass jcls, bool swig_mem_own, bool weak_global);
    SwigDirector_LocalSearchFilterManager(JNIEnv *jenv,std::vector< operations_research::LocalSearchFilterManager::FilterEvent > filter_events);
    SwigDirector_LocalSearchFilterManager(JNIEnv *jenv,std::vector< operations_research::LocalSearchFilter * > filters);
