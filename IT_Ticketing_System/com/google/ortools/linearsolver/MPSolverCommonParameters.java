...
private static final long serialVersionUID = 0L;
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 1,
      /* suffix= */ "",
      MPSolverCommonParameters.class.getName());
  }
  // Use MPSolverCommonParameters.newBuilder() to construct.
  private MPSolverCommonParameters(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public enum LPAlgorithmValues
    ...
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 1,
        /* suffix= */ "",
        LPAlgorithmValues.class.getName());
    }
    /**
     * <code>LP_ALGO_UNSPECIFIED = 0;</code>
     */
  ...
  @java.lang.Override public com.google.ortools.linearsolver.MPSolverCommonParameters.LPAlgorithmValues getLpAlgorithm() {
    com.google.ortools.linearsolver.MPSolverCommonParameters.LPAlgorithmValues result = com.google.ortools.linearsolver.MPSolverCommonParameters.LPAlgorithmValues.forNumber(lpAlgorithm_);
  ...
  @java.lang.Override public com.google.ortools.util.OptionalBoolean getPresolve() {
    com.google.ortools.util.OptionalBoolean result = com.google.ortools.util.OptionalBoolean.forNumber(presolve_);
  ...
  @java.lang.Override public com.google.ortools.util.OptionalBoolean getScaling() {
    com.google.ortools.util.OptionalBoolean result = com.google.ortools.util.OptionalBoolean.forNumber(scaling_);
    return result == null ? com.google.ortools.util.OptionalBoolean.BOOL_UNSPECIFIED : result;
  }
  ...
  public static final class Builder extends
    ...
    public Builder clear() {
      ...
      if (relativeMipGapBuilder_ != null) {
        relativeMipGapBuilder_.dispose();
        relativeMipGapBuilder_ = null;
      }
      primalTolerance_ = null;
      if (primalToleranceBuilder_ != null) {
        primalToleranceBuilder_.dispose();
        primalToleranceBuilder_ = null;
      }
      dualTolerance_ = null;
      if (dualToleranceBuilder_ != null) {
        dualToleranceBuilder_.dispose();
        dualToleranceBuilder_ = null;
      }
      lpAlgorithm_ = 0;
      presolve_ = 0;
      scaling_ = 0;
    ...
    private void buildPartial0(com.google.ortools.linearsolver.MPSolverCommonParameters result) {
      int from_bitField0_ = bitField0_;
      int to_bitField0_ = 0;
      if (((from_bitField0_ & 0x00000001) != 0)) {
        result.relativeMipGap_ = relativeMipGapBuilder_ == null
            ? relativeMipGap_
            : relativeMipGapBuilder_.build();
        to_bitField0_ |= 0x00000001;
      }
      if (((from_bitField0_ & 0x00000002) != 0)) {
        result.primalTolerance_ = primalToleranceBuilder_ == null
            ? primalTolerance_
            : primalToleranceBuilder_.build();
        to_bitField0_ |= 0x00000002;
      }
      if (((from_bitField0_ & 0x00000004) != 0)) {
        result.dualTolerance_ = dualToleranceBuilder_ == null
            ? dualTolerance_
            : dualToleranceBuilder_.build();
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              input.readMessage(
                  getRelativeMipGapFieldBuilder().getBuilder(),
                  extensionRegistry);
            ...
            case 18: {
              input.readMessage(
                  getPrimalToleranceFieldBuilder().getBuilder(),
                  extensionRegistry);
            ...
            case 26: {
              input.readMessage(
                  getDualToleranceFieldBuilder().getBuilder(),
                  extensionRegistry);
            ...
            case 32: {
              ...
              com.google.ortools.linearsolver.MPSolverCommonParameters.LPAlgorithmValues tmpValue =
                  com.google.ortools.linearsolver.MPSolverCommonParameters.LPAlgorithmValues.forNumber(tmpRaw);
              if (tmpValue == null) {
            ...
            case 40: {
              int tmpRaw = input.readEnum();
              com.google.ortools.util.OptionalBoolean tmpValue =
                  com.google.ortools.util.OptionalBoolean.forNumber(tmpRaw);
              if (tmpValue == null) {
    ...
    public Builder mergeRelativeMipGap(com.google.ortools.linearsolver.OptionalDouble value) {
      if (relativeMipGapBuilder_ == null) {
        if (((bitField0_ & 0x00000001) != 0) &&
          ...
          getRelativeMipGapBuilder().mergeFrom(value);
        } else {
          relativeMipGap_ = value;
        }
      } else {
    ...
    private com.google.protobuf.SingleFieldBuilder<
        ...
        getRelativeMipGapFieldBuilder() {
      if (relativeMipGapBuilder_ == null) {
        relativeMipGapBuilder_ = new com.google.protobuf.SingleFieldBuilder<
            com.google.ortools.linearsolver.OptionalDouble, com.google.ortools.linearsolver.OptionalDouble.Builder, com.google.ortools.linearsolver.OptionalDoubleOrBuilder>(
                getRelativeMipGap(),
    ...
    public Builder mergePrimalTolerance(com.google.ortools.linearsolver.OptionalDouble value) {
      if (primalToleranceBuilder_ == null) {
        if (((bitField0_ & 0x00000002) != 0) &&
          ...
          getPrimalToleranceBuilder().mergeFrom(value);
        } else {
          primalTolerance_ = value;
        }
      } else {
    ...
    private com.google.protobuf.SingleFieldBuilder<
        ...
        getPrimalToleranceFieldBuilder() {
      if (primalToleranceBuilder_ == null) {
        primalToleranceBuilder_ = new com.google.protobuf.SingleFieldBuilder<
            com.google.ortools.linearsolver.OptionalDouble, com.google.ortools.linearsolver.OptionalDouble.Builder, com.google.ortools.linearsolver.OptionalDoubleOrBuilder>(
                getPrimalTolerance(),
                getParentForChildren(),
                isClean());
    ...
    public Builder mergeDualTolerance(com.google.ortools.linearsolver.OptionalDouble value) {
      if (dualToleranceBuilder_ == null) {
        if (((bitField0_ & 0x00000004) != 0) &&
          ...
          getDualToleranceBuilder().mergeFrom(value);
        } else {
          dualTolerance_ = value;
        }
      } else {
    ...
    private com.google.protobuf.SingleFieldBuilder<
        ...
        getDualToleranceFieldBuilder() {
      if (dualToleranceBuilder_ == null) {
        dualToleranceBuilder_ = new com.google.protobuf.SingleFieldBuilder<
            com.google.ortools.linearsolver.OptionalDouble, com.google.ortools.linearsolver.OptionalDouble.Builder, com.google.ortools.linearsolver.OptionalDoubleOrBuilder>(
                getDualTolerance(),
                getParentForChildren(),
                isClean());
  ...
  private static final com.google.protobuf.Parser<MPSolverCommonParameters>
