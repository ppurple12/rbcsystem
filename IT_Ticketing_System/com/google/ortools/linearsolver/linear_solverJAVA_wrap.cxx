...
SWIGEXPORT jint JNICALL Java_com_google_ortools_linearsolver_mainJNI_MPSolver_1PDLP_1LINEAR_1PROGRAMMING_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  operations_research::MPSolver::OptimizationProblemType result;
  
  (void)jenv;
  (void)jcls;
  result = (operations_research::MPSolver::OptimizationProblemType)operations_research::MPSolver::PDLP_LINEAR_PROGRAMMING;
  jresult = (jint)result; 
  return jresult;
}
...
SWIGEXPORT jlong JNICALL Java_com_google_ortools_linearsolver_mainJNI_MPSolver_1createSolver(JNIEnv *jenv, jclass jcls, jstring jarg1) {
  jlong jresult = 0 ;
  std::string *arg1 = 0 ;
  operations_research::MPSolver *result = 0 ;
...
SWIGEXPORT jint JNICALL Java_com_google_ortools_linearsolver_mainJNI_MPSolver_1problemType(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jint jresult = 0 ;
  operations_research::MPSolver *arg1 = (operations_research::MPSolver *) 0 ;
  operations_research::MPSolver::OptimizationProblemType result;
  ...
  (void)jarg1_;
  arg1 = *(operations_research::MPSolver **)&jarg1; 
  result = (operations_research::MPSolver::OptimizationProblemType)((operations_research::MPSolver const *)arg1)->ProblemType();
  jresult = (jint)result; 
  return jresult;
}
...
SWIGEXPORT jlong JNICALL Java_com_google_ortools_linearsolver_mainJNI_MPSolver_1variable(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2) {
  jlong jresult = 0 ;
  operations_research::MPSolver *arg1 = (operations_research::MPSolver *) 0 ;
  int arg2 ;
...
SWIGEXPORT jlong JNICALL Java_com_google_ortools_linearsolver_mainJNI_MPSolver_1constraint(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jint jarg2) {
  jlong jresult = 0 ;
  operations_research::MPSolver *arg1 = (operations_research::MPSolver *) 0 ;
  int arg2 ;
...
SWIGEXPORT jint JNICALL Java_com_google_ortools_linearsolver_mainJNI_MPSolver_1solve_1_1SWIG_11(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_) {
  ...
  if (!arg2) {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "operations_research::MPSolverParameters const & is null");
    return 0;
  } 
...
SWIGEXPORT void JNICALL Java_com_google_ortools_linearsolver_mainJNI_MPSolver_1write(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jstring jarg2) {
  operations_research::MPSolver *arg1 = (operations_research::MPSolver *) 0 ;
  std::string *arg2 = 0 ;
...
SWIGEXPORT jstring JNICALL Java_com_google_ortools_linearsolver_mainJNI_MPSolver_1solverVersion(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  jstring jresult = 0 ;
  operations_research::MPSolver *arg1 = (operations_research::MPSolver *) 0 ;
  std::string result;
...
SWIGEXPORT jstring JNICALL Java_com_google_ortools_linearsolver_mainJNI_MPSolver_1loadModelFromProtoKeepNames(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jbyteArray jarg2) {
  jstring jresult = 0 ;
  operations_research::MPSolver *arg1 = (operations_research::MPSolver *) 0 ;
  operations_research::MPModelProto *arg2 = 0 ;
  operations_research::MPModelProto temp2 ;
...
SWIGEXPORT jstring JNICALL Java_com_google_ortools_linearsolver_mainJNI_MPSolver_1exportModelAsLpFormat_1_1SWIG_10(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_) {
  ...
  if (!arg2) {
    SWIG_JavaThrowException(jenv, SWIG_JavaNullPointerException, "operations_research::MPModelExportOptions const & is null");
    return 0;
  } 
...
SWIGEXPORT void JNICALL Java_com_google_ortools_linearsolver_mainJNI_MPSolver_1setHint(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jobjectArray jarg2, jdoubleArray jarg3) {
  ...
  arg1 = *(operations_research::MPSolver **)&jarg1; 
  {
    ...
    for (int i = 0; i < jenv->GetArrayLength(jarg2); i++) {
      ...
      result2.push_back(/*@SWIG:/usr/local/google/home/corentinl/work/main/ortools/util/java/vector.i,285,REINTERPRET_CAST@*/
